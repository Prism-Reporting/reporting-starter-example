...
const PROJECTS = [
  ...
  },
  {
    ...
    endDate: '2026-06-28',
    executiveSummary:
      'Data mapping is taking longer than planned and vendor cutover needs a revised sequence.',
  },
  {
    id: 'p-102',
    ...
    endDate: '2026-06-10',
    executiveSummary:
      'Pilot crews are already using the release candidate and defect volume is trending down.',
  },
  {
    id: 'p-103',
    ...
    endDate: '2026-06-30',
    executiveSummary:
      'Legal approval for external market feeds is still outstanding, which blocks the final analytics layer.',
  },
  {
    id: 'p-104',
    ...
    endDate: '2026-06-24',
    executiveSummary:
      'Audit workflow integration is working, but control evidence exports still require manual review.',
  },
  {
    id: 'p-105',
    ...
    endDate: '2026-05-18',
    executiveSummary:
      'Delivered to finance on schedule with a lighter than expected services footprint.',
  },
  {
    id: 'p-106',
    ...
    endDate: '2026-09-29',
    executiveSummary:
      'Discovery is complete and the external developer program is ready for onboarding.',
  },
  {
    id: 'p-107',
    ...
    endDate: '2026-09-15',
    executiveSummary:
      'Source-system ingestion is stable and dashboard requirements are nearly finalized.',
  },
];
...
const MILESTONES = [
  ...
  },
  {
    ...
    percentComplete: 54,
    summary:
      'Launch readiness is on track pending performance validation in the final environment.',
  },
  {
    id: 'm-1011',
    projectId: 'p-101',
...
function filterMilestones(params = {}) {
  ...
  return MILESTONES.filter((milestone) => !params.status || milestone.status === params.status)
